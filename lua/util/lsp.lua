...
M.on_attach = function(client, bufnr)
	...
	mapkey("<leader>vd", "Lspsaga show_cursor_diagnostics", "n", opts) -- show diagnostics for cursor
	mapkey("<leader>df", "Lspsaga show_buf_diagnostics", "n", opts) -- show diagnostics for buffer
	mapkey("<leader>dw", "Lspsaga show_workspace_diagnostics", "n", opts) -- show diagnostics for buffer
